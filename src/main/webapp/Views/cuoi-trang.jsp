		...
		<div class="row">
			<div class="col-md-3 col-sm-6">
				<div class="footer-about-us">
					...
					<p>Mua Giày chính hãng nhập khẩu từ các thương hiệu nổi tiếng: Adidas, Nike, Gucci,
					 Converse, Vans, Fila, Vascara, MLB…chất lượng hàng đầu được kiếm chứng bởi ShoeShop</p>
			...
			<div class="col-md-3 col-sm-6">
				<div class="footer-menu">
					...
					<form action="DangNhapServlet" method="post">
						...
						<input type="submit" name="btnDangNhap" value="Đăng nhập" /><br>
