            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="cart.html">Giỏ hàng: <span class="cart-amunt"><fmt:formatNumber value="${sessionScope.gioHang.tongTien() }" pattern="#,###" /></span> <i class="fa fa-shopping-cart"></i> <span class="product-count">${sessionScope.gioHang.soMatHang()}</span></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="trang-cua-hang.jsp">STORE</a></li>
                        <li><a href="trang-san-pham.jsp">PRODUCT</a></li>
                        <li><a href="trang-gio-hang.jsp">CART</a></li>
